...
void portb_handler(void)
{
  ...
  //      stopflag=0;
    ...
    //    disable_irq (PIT2_IRQn);                                     //使能PIT1中断
    //    SPeedAim(0); 
     //   DELAY_MS(800);
        /*
  ...
  */ 
    ...
    m=7;
          if(PORTB_ISFR & (1 << m))           //PTA6触发中断
    {
        PORTB_ISFR  = (1 << m);        //写1清中断标志位
...
//turn=turn+100;
    ...
    m=27;
          if(PORTE_ISFR & (1 << m))           //PTA6触发中断
    {
        PORTE_ISFR  = (1 << m);        //写1清中断标志位
